...
namespace Lab4COM3773.Controllers
{
    ...
    public class ProvincesController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var team = await _context.Provinces
        ...
        public async Task<IActionResult> Create([Bind("ProvinceCode, ProvinceName, Cities")] Province province)
        {
        ...
        {
            return _context.Provinces.Any(p => p.ProvinceCode == id);
        }
    }
}
